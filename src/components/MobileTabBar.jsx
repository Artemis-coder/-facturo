...
export function MobileTabBar({ tabs = [], quickActions = [], view, setView, onQuickCreate, onOpenMenu }) {
    ...
    <>
      <nav className="mobile-tabbar" style={{
        ...
        <div style={{ display: "flex", alignItems: "stretch", height: 60 }}>
          ...
          <TabItem tab={{ key: "__menu__", label: "Menu", icon: Menu }} active={menuActive} onSelect={onOpenMenu} />
        </div>
      </nav>
